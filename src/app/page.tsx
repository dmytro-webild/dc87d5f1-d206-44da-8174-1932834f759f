...
export default function LandingPage() {
      ...
      avatars={[
        {
          ...
          alt: "Electrical technician looking focused while working in a switchboard with fuses",
        },
        {
          src: "http://img.b2bpic.net/free-photo/service-man-adjusting-house-heating-system_1303-26529.jpg",
          alt: "Service man adjusting house heating system",
        },
        {
          src: "http://img.b2bpic.net/free-photo/service-man-instelling-house-heating-system-floor_1303-26533.jpg",
          alt: "Service man instelling house heating system under the floor",
        },
        {
          src: "http://img.b2bpic.net/free-photo/seasoned-mechanic-using-soft-dusting-brush-sweep-away-built-up-layer-dirt-debris-from-hvac-system-coil-while-adept-repairman-refills-air-conditioner-cooling-system-refrigerant-tank_482257-63969.jpg",
          alt: "Seasoned mechanic using soft dusting brush to sweep away built up layer of dirt and debris from hvac system coil while adept repairman refills air conditioner cooling system refrigerant tank",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-man-shirt-vest-standing-with-crossed-arms-looking-confident_176474-30879.jpg",
          alt: "Young man in shirt, vest standing with crossed arms and looking confident .",
        },
      ]}
      marqueeItems={[
        {
      ...
      bulletPoints={[
        {
          ...
          description: "Respecting your time with punctual service.",
        },
        {
          title: "Total Transparency",
          description: "Full explanations before a wrench touches anything.",
        },
        {
          title: "Professional Cleanliness",
          description: "Leaving your home as clean as we found it.",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-woman-wearing-helmet_23-2149366663.jpg",
          alt: "Client 2",
        },
        {
      ...
      faqs={[
        {
          ...
          content: "Yes, we provide rapid response for emergency furnace and AC situations to keep your home comfortable.",
        },
        {
          id: "f2",
          title: "Are your quotes upfront?",
          content: "Absolutely. We provide detailed pricing before starting any work—no surprises, just straight answers.",
        },
        {
          id: "f3",
          title: "How often should I get maintenance?",
          content: "Annual maintenance is recommended to extend the lifespan of your unit and prevent costly, unexpected breakdowns.",
        },
      ]}
